...
void PoseGraph::addKeyFrame(KeyFrame* cur_kf, bool flag_detect_loop)// add keyframe, loop detection
{
    Vector3d vio_P_cur;
    Matrix3d vio_R_cur;
    ...
    cur_kf->getVioPose(vio_P_cur, vio_R_cur);
     // the pose of the current frame after loop closure
    ...
    // save loop path to ESVIO_RESULT_PATH
    if (SAVE_LOOP_PATH)
    {
