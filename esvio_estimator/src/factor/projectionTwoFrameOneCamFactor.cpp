...
void ProjectionTwoFrameOneCamFactor::setInfoMatrix(Eigen::Matrix2d& OMEGA){
    sqrt_info = OMEGA ; 
}
...
bool ProjectionTwoFrameOneCamFactor::Evaluate(double const *const *parameters, double *residuals, double **jacobians) const
{
    ...
    // cout<<"pts_i: "<<pts_i.transpose()<<" velocity_i: "<<velocity_i.transpose()<<endl; 
    // cout<<"td: "<<td<<" td_i: "<<td_i<<endl; 
    // cout<<"pts_i_td: "<<pts_i_td.transpose()<<" pts_j_td: "<<pts_j_td.transpose()<<endl; 
    // cout<<"pts_camera_i: "<<pts_camera_i.transpose()<<" pts_camera_j: "<<pts_camera_j.transpose()<<endl; 
...
bool ProjectionTwoFrameOneCamFactor::debug(double const *const *parameters, double *residuals, double **jacobians) const
{
    TicToc tic_toc;
    Eigen::Vector3d Pi(parameters[0][0], parameters[0][1], parameters[0][2]);
    Eigen::Quaterniond Qi(parameters[0][6], parameters[0][3], parameters[0][4], parameters[0][5]);
